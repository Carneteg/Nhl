...
def load_fixtures(db):
    ...
    personalities=["Aggressive contender","Conservative","Analytics-driven","Old-school scout","Rebuild specialist","Cap disciplinarian","Draft-and-develop","Patient developer"]
